  ...
  return (
    <section id="cinematic-hero" className="relative w-full h-screen bg-black overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[30%] bg-gradient-to-t from-black via-black/60 to-transparent pointer-events-none z-[2]" />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-between p-8 pt-20 md:p-16 lg:p-24">
          <div className="flex flex-col justify-center items-center md:items-start flex-1 text-left">
          ...
          <motion.div 
            ...
            className="flex flex-col items-center w-full gap-3 mix-blend-difference pb-8"
          >
