  ...
  return (
    <main className="min-h-screen bg-[var(--background)] selection:bg-[var(--dada-red)] selection:text-white overflow-x-hidden">
      ...
      <FeatureSection 
        ...
        text={<p>Gabrielle sees color everywhere, in the light on a wall at golden hour, in the way a scarf falls across someone&apos;s shoulder, in the rust on an old gate. She trained in fashion design at the Scandinavian Academy of Fashion Design in Copenhagen before following her heart to the canvas. But that love of fabric, of how something drapes and moves, never left her. It lives in every painting she makes, and eventually, it finds its way back into cloth.</p>}
